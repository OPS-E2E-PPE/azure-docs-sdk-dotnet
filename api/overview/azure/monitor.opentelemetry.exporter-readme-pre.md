...
keywords: Azure, dotnet, SDK, API, Azure.Monitor.OpenTelemetry.Exporter, 
author: maggiepint
ms.author: magpint
ms.date: 03/05/2021
ms.topic: article
...
# Azure Monitor Exporter client library for .NET - Version 1.0.0-beta.2 
...
Refer to [`DemoTrace.cs`](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Monitor.OpenTelemetry.Exporter_1.0.0-beta.2/sdk/monitor/Azure.Monitor.OpenTelemetry.Exporter/tests/Azure.Monitor.OpenTelemetry.Exporter.Demo.Tracing/DemoTrace.cs) for a complete demo.
...
See [CONTRIBUTING.md](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Monitor.OpenTelemetry.Exporter_1.0.0-beta.2/CONTRIBUTING.md) for details on contribution process.
