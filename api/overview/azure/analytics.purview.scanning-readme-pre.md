...
keywords: Azure, dotnet, SDK, API, Azure.Analytics.Purview.Scanning, 
author: maggiepint
ms.author: magpint
ms.date: 05/13/2021
ms.topic: article
...
# Azure Purview Scanning client library for .NET - Version 1.0.0-beta.1 
...
### Additional concepts
<!-- CLIENT COMMON BAR -->
[Client options](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/README.md#configuring-service-clients-using-clientoptions) |
[Accessing the response](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/README.md#accessing-http-response-details-using-responset) |
[Long-running operations](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/README.md#consuming-long-running-operations-using-operationt) |
[Handling failures](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/README.md#reporting-errors-requestfailedexception) |
[Diagnostics](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/samples/Diagnostics.md) |
[Mocking](https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/README.md#mocking) |
...
<!-- LINKS -->
[source_code]: https://github.com/Azure/azure-sdk-for-net/tree/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/purview/Azure.Analytics.Purview.Scanning/src
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-net/tree/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/identity/Azure.Identity
...
[azure_core_diagnostics]: https://github.com/Azure/azure-sdk-for-net/blob/Azure.Analytics.Purview.Scanning_1.0.0-beta.1/sdk/core/Azure.Core/samples/Diagnostics.md
